            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(route('employees.index')); ?>"
                            class="nav-link">Daftar Buku</a></li>
                </ul>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="lastName" class="form-label">Penulis</label>
...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="email" id="email" value="<?php echo e(old('email')); ?>" placeholder="Enter Email Penerbit"
                                required="">
...
unset($__errorArgs, $__bag); ?>" type="text" name="age"
                                id="age" value="<?php echo e(old('age')); ?>" placeholder="Enter Harga" required="">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="position" class="form-label">Penerbit</label>
...
<?php /**PATH E:\PrakMod05_FemWKWK-main\PrakMod05_FemWKWK-main\resources\views/employee/create.blade.php ENDPATH**/ ?>