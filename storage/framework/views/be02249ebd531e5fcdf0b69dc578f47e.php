            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav flex-row flex-wrap">
                    ...
                    <li class="nav-item col-2 col-md-auto"><a href="<?php echo e(route('employees.index')); ?>"
                            class="nav-link active">Daftar Buku</a></li>
                </ul>
        ...
        <div class="row mb-0">
            ...
            <div class="col-lg-3 col-xl-2">
                <div class="d-grid gap-2">
                    <a href="<?php echo e(route('employees.create')); ?>" class="btn btn-primary">Create Buku</a>
                </div>
            </div>
        </div>
        <hr>
...
<?php /**PATH E:\PrakMod05_FemWKWK-main\PrakMod05_FemWKWK-main\resources\views/employee/index.blade.php ENDPATH**/ ?>