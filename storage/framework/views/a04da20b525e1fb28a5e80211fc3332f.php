...
unset($__errorArgs, $__bag); ?>" type="text"
                                name="email" id="email" value="<?php echo e($employee->email); ?>" placeholder="Enter Email Penerbit"
                                required="">
...
unset($__errorArgs, $__bag); ?>" type="text" name="age"
                                id="age" value="<?php echo e($employee->age); ?>" placeholder="Enter Harga" required="">
                            <?php $__errorArgs = ['age'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
<?php /**PATH E:\PrakMod05_FemWKWK-main\PrakMod05_FemWKWK-main\resources\views/employee/edit.blade.php ENDPATH**/ ?>