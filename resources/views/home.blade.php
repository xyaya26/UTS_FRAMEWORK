...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-primary">
        <div class="container">
            <a href="{{ route('home') }}" class="navbar-brand mb-0 h1"><i class="bi-hexagon-fill me-2"></i> Marketplace</a>
...
<section class="about" id="about">
    ...
    <div class="row">
        <div class="video-container">
            <video src= "{{ Vite::asset('resources/images/about-vid.mp4') }}" loop autoplay muted></video>
            <h3> Best Seller </h3>
        </div>
...
<section class="icons-container">
    <div class="icons">
        <img src="{{ Vite::asset('resources/images/icon-1.png') }}" alt="">
        <div class="info">
            <h3> Free Delivery </h3>
            <span>on all orders </span>
        </div>

        <img src= "{{ Vite::asset('resources/images/icon-2.png') }}" alt="">
        <div class="info">
            <h3> 7 hari return </h3>
            <span> moneyback </span>
        </div>

        <img src="{{ Vite::asset('resources/images/icon-3.png') }}" alt="">
        <div class="info">
            <h3> Offer & gifts </h3>
            <span>on all orders </span>
        </div>

        <img src= "{{ Vite::asset('resources/images/icon-4.png') }}" alt="">
        <div class="info">
...
<section class="products" id="products">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-1.jpeg')}}" alt="">
                <div class="icons">
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-2.jpeg')}}" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Keranjang</a>
                    <a href="#" class="fas fa-share"></a>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-3.jpeg')}}" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Keranjang</a>
                    <a href="#" class="fas fa-share"></a>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-4.jpeg')}}" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Keranjang</a>
                    <a href="#" class="fas fa-share"></a>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-5.jpeg')}}" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Keranjang</a>
                    <a href="#" class="fas fa-share"></a>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-6.jpeg')}}" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Keranjang</a>
                    <a href="#" class="fas fa-share"></a>
        ...
        <div class="box">
            ...
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-7.jpeg')}}" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Keranjang</a>
                    <a href="#" class="fas fa-share"></a>
        ...
        <div class="box">
            <span class="discount">-10%</span>
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-8.jpeg')}}" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Keranjang</a>
                    <a href="#" class="fas fa-share"></a>
        ...
        <div class="box">
            <span class="discount">-5%</span>
            <div class="image">
                <img src="{{ Vite::asset('resources/images/img-9.jpeg')}}" alt="">
                <div class="icons">
                    <a href="#" class="fas fa-heart"></a>
                    <a href="#" class="cart-btn">Keranjang</a>
                    <a href="#" class="fas fa-share"></a>
...
<section class="review" id="review">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="{{ Vite::asset('resources/images/pic-1.png')}}" alt="">
                <div class="user-info">
                    <h3>Bambang</h3>
                    <span>Ramah</span>
                </div>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="{{ Vite::asset('resources/images/pic-2.png')}}" alt="">
                <div class="user-info">
                    <h3>Elsa Nuryati</h3>
                    <span>Ramah </span>
                </div>
        ...
        <div class="box">
            ...
            <div class="user">
                <img src="{{ Vite::asset('resources/images/pic-3.png')}}" alt="">
                <div class="user-info">
                    <h3>Josep</h3>
                    <span>Ramah</span>
                </div>
    ...
    <section class="contact" id="contact">
        ...
        <div class="row">
            ...
            <div class="image">
                <img src="{{ Vite::asset('resources/images/contact-img.svg')}}" alt="">
            </div>
